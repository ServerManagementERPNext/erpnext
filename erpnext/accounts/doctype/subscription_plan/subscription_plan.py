...
def get_plan_rate(
	...
	if plan.price_determination == "Fixed Rate":
	...
	elif plan.price_determination in ("Monthly Rate", "Based On Price List"):
		if plan.price_determination == "Based On Price List":
			...
			if not price:
				...
				monthly_rate = price.price_list_rate_sales_uom * prorate_factor
		else:
			monthly_rate = plan.cost
		...
		cost = monthly_rate * no_of_months
		...
		if prorate and no_of_days:
			...
			cost += monthly_rate * no_of_days / avg_days_in_month
